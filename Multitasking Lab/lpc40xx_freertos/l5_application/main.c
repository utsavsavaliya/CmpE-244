...
int main(void) {
  ...
  puts("Starting RTOS Get Ready");

  xTaskCreate(task_one, "1", 4096 / sizeof(void *), (void *)1, 2, NULL); //
  xTaskCreate(task_two, "2", 4096 / sizeof(void *), (void *)1, 1, NULL);
...
static void task_one(void *task_parameter) {
  ...
  while (1) {
    vTaskDelay(1000);
    fprintf(stderr, "AAABAAABAAABAAA");
  }
}
...
static void task_two(void *task_parameter) {
  ...
  while (1) {
    vTaskDelay(1000);
    fprintf(stderr, "CCCDCCCDCCCDCCC");
  }
}
